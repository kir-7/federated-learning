...
class FlowerClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config):
        ...
        return final_loss, len(val_data), {"val_acc": accuracy, "macro_precision":macro_precision, "macro_recall":macro_recall, "macro_f1":macro_f1, "data_samples":len(val_data), "val_loss":final_loss}
